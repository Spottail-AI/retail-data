...
export const TrendingEcommerceProductsUSHeroSection = () => {
  const scrollToDemo = () => {
    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-28">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-10 leading-tight tracking-wide">
          Find Trending eCommerce Products in the United States
        </h1>
        <p className="text-lg md:text-xl text-muted-foreground mb-16 max-w-3xl mx-auto leading-relaxed">
          Jump on the next trend. Find trending eCommerce products that people are talking about and stay ahead of the curve!
        </p>
        <div className="flex justify-center items-center mb-24">
          <Button size="lg" className="bg-cta hover:bg-cta/90 text-cta-foreground px-10 py-5 text-lg font-semibold rounded-lg shadow-lg shadow-cta/20 transition-all duration-300 hover:shadow-xl hover:shadow-cta/30" onClick={scrollToDemo}>
            Start Researching Products Free<ArrowRight className="ml-2 w-5 h-5" />
          </Button>
        </div>
