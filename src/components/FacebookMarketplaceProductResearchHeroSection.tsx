...
export const FacebookMarketplaceProductResearchHeroSection = () => {
  const scrollToDemo = () => {
    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-slate-800 mb-6 leading-tight">
          Product Research Tool for
          <br />
          <span className="bg-gradient-to-r from-emerald-500 to-blue-600 bg-clip-text text-transparent">Facebook Marketplace</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
          Stay ahead of the curve. Discover trending products that are about to win on Facebook Marketplace.
        </p>
