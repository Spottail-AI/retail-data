  ...
  return (
    ...
    >
      <div className="mx-auto w-full text-center" style={{ maxWidth: 900 }}>
        ...
        <div className="hero-bottom-v2 flex items-center justify-center flex-wrap" style={{ gap: 12, marginTop: 22, paddingTop: 5, borderTop: "1px solid rgba(255,255,255,0.07)" }}>
